...
public:
	...
	virtual LONG Setup (EBaudrate eBaudrate = EBaudrate::EBaud9600,
						EDataBits eDataBits = EDataBits::EData8,
						EParity   eParity   = EParity::EParNone,
						EStopBits eStopBits = EStopBits::EStop1);
	...
	virtual LONG SetMask (DWORD dwMask = static_cast<DWORD>(EEvent::EEventBreak) | static_cast<DWORD>(EEvent::EEventError) | static_cast<DWORD>(EEvent::EEventRecv));
	...
	// New functions added according to comments section of CodeProject
