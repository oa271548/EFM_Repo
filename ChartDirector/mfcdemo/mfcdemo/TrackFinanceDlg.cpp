...
BEGIN_MESSAGE_MAP(CTrackFinanceDlg, CDialogEx)
...
BOOL CTrackFinanceDlg::OnInitDialog()
{
    ...
    SetWindowTextW(L"Finance Chart Track Line");
...
void CTrackFinanceDlg::trackFinance(MultiChart *m, int mouseX)
{
    ...
    for(int i = 0; i < m->getChartCount(); ++i) {
        ...
        // Iterate through all layers to create the legend for every layers in the chart
