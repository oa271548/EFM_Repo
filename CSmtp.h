...
// **BOB**
// MEMORY LEAKS: OpenSSL does have documented memory leaks but they do not
// grow in size.  
// Found leaks of: 12, 64, 96, 396, 16, 20 bytes.
...
public:
	...
	bool ConnectRemoteServer(const char* szServer, const unsigned short nPort_=0,
							 SMTP_SECURITY_TYPE securityType = SMTP_SECURITY_TYPE::DO_NOT_SET,
...
private:
	SMTP_SECURITY_TYPE m_type = SMTP_SECURITY_TYPE::DO_NOT_SET;
